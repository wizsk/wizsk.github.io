// dont't wann deal with multiple footer it's painfull
// so javascirpt it is :)
...
const linkHeight = document.getElementById('links').getBoundingClientRect().bottom
